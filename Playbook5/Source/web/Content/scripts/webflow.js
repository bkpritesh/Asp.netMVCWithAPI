...
(function () {
  ...
  var require1$$0 = (webflowLib && typeof webflowLib === 'object' && 'default' in webflowLib ? webflowLib['default'] : webflowLib);
    var require1$$0$2 = (webflowIxEvents && typeof webflowIxEvents === 'object' && 'default' in webflowIxEvents ? webflowIxEvents['default'] : webflowIxEvents);
    ...
    var webflowTabs = __commonjs(function (module) {
        ...
        var Webflow = require1$$0;
        var IXEvents = require1$$0$2;
        ...
        Webflow.define('tabs', module.exports = function ($) {
            ...
            var tabDisabled = 'data-w-Disabled';
            ...
            function build(i, el) {
                ...
                if (!design) {
                    ...
                    var tabDisabledData = $link.attr(tabDisabled);
                    tab && changeTab(data, { tab: tab, immediate: true, tabDisabled: tabDisabledData });
                }
            }
            ...
            function linkSelect(data) {
                return function (evt) {
                    var tabDisabledData = evt.currentTarget.getAttribute(tabDisabled); 
                    var tab = evt.currentTarget.getAttribute(tabAttr);
                    tab && changeTab(data, { tab: tab, tabDisabled: tabDisabledData });
                };
            }
            ...
            function changeTab(data, options) {
                ...
                var tab = options.tab;
                var tabDisabledData = options.tabDisabled;
                // Don't select the same tab twice
                if (tab === data.current || tabDisabledData ==="true") return;
                data.current = tab;
...
Webflow.require('ix').init([
  ...
  { "slug": "show-on-load", "name": "Show On Load", "value": { "style": { "display": "none", "opacity": 0, "x": "0px", "y": "15px", "z": "0px" }, "triggers": [{ "type": "click", "stepsA": [{ "display": "none", "opacity": 0, "transition": "opacity 500ms ease 0, transform 200 ease 0", "x": "0px", "y": "15px", "z": "0px" }], "stepsB": [] }, { "type": "load", "stepsA": [{ "wait": "1000ms" }, { "display": "block", "opacity": 1, "transition": "transform 500ms ease 0, opacity 500ms ease 0" }], "stepsB": [] }] } },
    {
        "slug": "collapse-teaminfo",
        "name": "Collapse TeamInfo",
        "value": {
            "style": {},
            "triggers": [
                {
                    "type": "click",
                    "selector": ".div_teaminfo",
                    "stepsA": [
                        {
                            "opacity": 0,
                    ...
                    "stepsB": [
                        ...
                        },
                        {
                            "wait": "220ms",
                            "opacity": 1,
                            "transition": "opacity 240ms ease 0"
                        }
                    ]
                },
                {
